...
import com.example.android.ecommerce.ViewHolder.ProductViewHolder;
    ...
    private void changeProductState(String productID) {
            ...
            unverifiedProductsRef.child(productID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(AdminCheckNewProductsActivity.this, "Product Approved Successfully", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    }
